...
var pluginBase = core.PluginBase{Name: "YouTube", Type: api.PluginTypeInput}

func NewYouTube() (ret *YouTube) {
	ret = &YouTube{PluginBase: pluginBase}
	return
}
...
func (o *YouTube) initService() (err error) {
	if o.service == nil {
		...
		o.service, err = youtube.NewService(ctx, option.WithAPIKey(o.ApiKey))
	}
	return
}
...
func (o *YouTube) GrabByFlags() (ret *VideoInfo, err error) {
	...
	ytUrl := flag.Arg(0)
	ret, err = o.Grab(ytUrl, options)
	return
}

func NewFactory() (ret *Factory) {
	ret = &Factory{core.PluginFactoryBase[api.Input]{PluginBase: pluginBase}}
	return
}

type Factory struct {
	core.PluginFactoryBase[api.Input]
}

func (o *Factory) Setup(label string) (settings map[string]string, err error) {
	return
}

func (o *Factory) Create(label string, settings map[string]string) (ret api.Plugin, err error) {
	ret = NewYouTube()
	return
}
